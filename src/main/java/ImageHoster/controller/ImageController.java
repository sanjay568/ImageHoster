...
public class ImageController {
    ...
    public String showImage(@ModelAttribute("message") String message,@ModelAttribute("deleteMessage") String deleteMsg,@PathVariable("id") int id, Model model) {
    ...
    public String addComment( @PathVariable("imageId") int id,@PathVariable("imageTitle") String imageTitle,HttpSession session,HttpServletRequest request,RedirectAttributes redirectAttributes) {
    	...
    	commentService.addComment(user, image, comment);
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session,RedirectAttributes redirectAttributes) {
        ...
        if(user.getId()==loggedInUser.getId()) {
        	...
        	redirectAttributes.addFlashAttribute("message","Only the owner of the image can edit the image");
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId,HttpSession session,RedirectAttributes redirectAttributes) {
         ...
         if(loggedInUser.getId()==image.getId()) {
        	 ...
        	 redirectAttributes.addFlashAttribute("deleteMessage","Only the owner of the image can delete the image");
        	 return "redirect:/images/"+imageId;
         }
